...
var drrss = tryRequire( resolve( __dirname, './../lib/drrss.native.js' ) );
var opts = {
...
tape( 'the function calculates the square root of the residual sum of squares', opts, function test( t ) {
	var x;
	var y;
	var z;
