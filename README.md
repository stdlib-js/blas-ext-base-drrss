...
```javascript
drrss = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-drrss@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/blas-ext-base-drrss/tags). For example,

```javascript
drrss = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-drrss@v0.1.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var drrss = require( 'path/to/vendor/umd/blas-ext-base-drrss/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-drrss@umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-drrss/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/blas-ext-base-drrss/actions/workflows/test.yml?query=branch:v0.1.0
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/blas-ext-base-drrss.svg
[dependencies-url]: https://david-dm.org/stdlib-js/blas-ext-base-drrss/main
...
[deno-url]: https://github.com/stdlib-js/blas-ext-base-drrss/tree/deno
[deno-readme]: https://github.com/stdlib-js/blas-ext-base-drrss/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/blas-ext-base-drrss/tree/umd
[umd-readme]: https://github.com/stdlib-js/blas-ext-base-drrss/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/blas-ext-base-drrss/tree/esm
[esm-readme]: https://github.com/stdlib-js/blas-ext-base-drrss/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/blas-ext-base-drrss/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/blas-ext-base-drrss/main/LICENSE
